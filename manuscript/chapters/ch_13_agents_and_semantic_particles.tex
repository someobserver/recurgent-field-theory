...
\label{ch:agents_and_semantic_particles}
...
\label{sec:the_agent_field_interaction_lagrangian}
...
\label{sec:interpretation_as_variational_transformation}
...
\label{sec:operator_theoretic_formulation_of_interpretation}
...
\label{sec:formal_definition_of_an_agent}

\chapter{Recursive Coupling and Depth Fields}\label{ch:recursive_coupling_and_depth_fields}
...
\subsection{On Contrapuntal Coupling}\label{sec:on_contrapuntal_coupling}

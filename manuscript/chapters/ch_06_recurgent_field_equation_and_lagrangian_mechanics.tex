\chapter{Recurgent Field Equation and Lagrangian Mechanics}\label{ch:recurgent_field_equation_and_lagrangian_mechanics}
...
\section{Lagrangian Density}\label{sec:lagrangian_density}
...
\subsection{Complex Field Formulation}\label{sec:complex_field_formulation}
...
\section{The Principle of Stationary Action}\label{sec:the_principle_of_stationary_action}
...
\section{Euler–Lagrange Field Equation}\label{sec:euler_lagrange_field_equation}
...
\section{Microscopic Dynamics and Field Coupling}\label{sec:microscopic_dynamics_and_field_coupling}
...
\subsection{Semantic Field Evolution}\label{sec:semantic_field_evolution}
...
\subsection{The Coupled Dynamical System}\label{sec:the_coupled_dynamical_system}

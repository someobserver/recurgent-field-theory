\chapter{Autopoietic Function and Phase Transitions}\label{ch:autopoietic_function_and_phase_transitions}
...
\section{Definition and Lagrangian Integration}\label{sec:definition_and_lagrangian_integration}

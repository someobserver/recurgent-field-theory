\chapter{Semantic Manifold and Metric Geometry}\label{ch:semantic_manifold_geometry}
...
\section{Evolution Equation for the Semantic Metric}\label{sec:metric_evolution}
